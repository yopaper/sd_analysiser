...
class NumberBar:
    def __init__(self, master, width:int=100, height:int=15) -> None:
        ...
        self._title_label = tk.Label( self.main_frame )
        self._title_label.grid( column=0, row=0, padx=1 )
        self._bar_canvas = tk.Canvas( self.main_frame, width=width, height=height )
        self._bar_canvas.grid( column=1, row=0, padx=1 )
        self._number_label = tk.Label( self.main_frame )
    ...
    def grid( self, column:int, row:int ):
        self.main_frame.grid( column=column, row=row, padx=4, pady=4 )
    #--------------------------------------------------------------------------------------
